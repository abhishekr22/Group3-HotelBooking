...
public class CustomReviewRepositoryImpl implements CustomReviewRepository{
	...
	Session session = entityManager.unwrap(Session.class);
		String queryString = "from Hotel h,Review r where h.city=:cityname";
	...
	public List<Review> getreviewbyhotelname(String hotelname) {
		Session session = entityManager.unwrap(Session.class);
		String queryString = "from Review r,Hotel h where h.hotelname=:hotelname and h.hotel_id=r.review_id";
		Query<Review> query = session.createQuery(queryString);
